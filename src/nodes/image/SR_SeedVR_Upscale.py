...
class SR_SeedVR_Upscale:
    ...
    return {
      "required": {
        ...
        "width_below": ("INT", {
          ...
          "max": 10000,
          "step": 1,
          "description": "Width below which the image will be upscaled"
        }),
        "height_below": ("INT", {
          "default": 1280,
          "min": 256,
          "max": 10000,
          "step": 1,
          "description": "Height below which the image will be upscaled"
        }),
        "image": ("IMAGE",),
  ...
  def upscale_image(self, api_key, image, upscale_factor, seed, width_below, height_below):
    ...
    try:
      ...
      if original_width > width_below and original_height > height_below:
        print(f"[Fal SeedVR Upscale] Image is below the width or height threshold, skipping upscale")
...
NODE_CLASS_MAPPINGS = {
  "SR_SeedVR_Upscale": SR_SeedVR_Upscale,
}

NODE_DISPLAY_NAME_MAPPINGS = {
  "SR_SeedVR_Upscale": "SR SeedVR Upscale Conditioned",
}
