    ...
    def __reload(self, module_name: str) -> web.Response:
        ...
        with self.__lock:
            ...
            try:
                ...
                # Update global node registries
                if hasattr(module, "NODE_CLASS_MAPPINGS") and module.NODE_CLASS_MAPPINGS:
                    GLOBAL_NODE_CLASS_MAPPINGS.update(module.NODE_CLASS_MAPPINGS)
                ...
                if hasattr(module, "NODE_DISPLAY_NAME_MAPPINGS") and module.NODE_DISPLAY_NAME_MAPPINGS:
                    GLOBAL_NODE_DISPLAY_NAME_MAPPINGS.update(module.NODE_DISPLAY_NAME_MAPPINGS)
